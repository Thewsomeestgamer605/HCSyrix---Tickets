...
module.exports = {
  ...
  execute(client, message, args) {
    ...
    if (!suggestionQuery) return message.channel.send("<:x_:755873672954380298> | Please specify a fixed! **`(You can add a single image)`**");
    ...
    const embedSuggest = new Discord.MessageEmbed()
      .setTitle("__**Fixed**__")
      .setThumbnail("https://i.imgur.com/ThUnm8a.png")
      .setFooter("Hely Bot | Fixed", client.user.displayAvatarURL())
